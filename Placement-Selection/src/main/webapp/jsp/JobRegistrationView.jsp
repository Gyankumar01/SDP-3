...
<%@page import="in.co.placement.selection.controller.JobRegisterCtl"%>
		...
		<div class="row">
			<div class="col-lg-8">
				...
				<form class="contact-form php-mail-form" role="form"
					action="<%=PSView.JOB_REGISTRATION_CTL %>" method="POST" >
					<jsp:useBean id="bean"
              ...
              <b><font color="Green"> <%=ServletUtility.getSuccessMessage(request)%>
					...
					<label for="exampleInputPassword1" class="form-label">SELECT COMPANY</label>
					<div class="mb-10">
								<select class="form-control" name="companyName" style=" width: 750px; margin: 5px;" required>
					...
					%>	
								...
								<option value="<%=rs.getString(1)%>" required ><%=rs.getString(2) %></option>
					...
					<div class="mb-3">
						...
						<input type="text" name="dop" class="form-control" value="<%=DataUtility.getStringData(bean.getJobPostDate()) %>"
							id="exampleInputPassword1" placeholder ="Enter Date in DD/MM/YYYY">
					...
					<button type="submit" name="operation"
						value="<%=JobRegisterCtl.OP_SIGN_UP%>"
						class="btn btn-primary mb-2">Add Job</button>

		...
		<div class="container">
			...
			<div class="navbar-collapse collapse navbar-right">
				<ul class="nav navbar-nav">
					...
					<li><a class="navbar-brand" href="<%=PSView.APPLICATION_LIST_CTL%>">Applicant Report</a></li> 
					<li><a href="<%=PSView.MY_PROFILE_CTL%>">Profile</a></li>
					<li><a href="<%=PSView.CHANGE_PASSWORD_CTL%>">Change Password</a></li>
							
							<li><a
								href="<%=PSView.LOGOUT_CTL%>?operation=<%=LoginCtl.OP_LOG_OUT%>">Log
									out</a></li>
